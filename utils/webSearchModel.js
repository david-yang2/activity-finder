...
export const webSearchModel = async (query, distance) => {
  ...
  const prompt = `
      You are an activity suggestion assistant. You will be given a user's location and the weather for their location. Using the user's location and weather, you will suggest at maximum of 5 activities within ${distance} miles of the user's location. 
      
      Find activities for the day that the user explicitly asks for. If the user does not specify a date, you will find activities that are occurring today. If the user asks for activities for tomorrow, you will find activities that are occurring tomorrow. If the user asks for activities for the weekend, you will find activities that are occurring on this upcoming Saturday and Sunday. 
